...
@section('content')
    <div id="theme-main-banner" class="banner-one">
        <div data-src="users/images/home/slide-1.jpg">
            <div class="camera_caption">
                <div class="container">
                    ...
                    <a href="contact.html" class="theme-button-one wow fadeInUp animated" data-wow-delay="0.39s">CONTACT
                        US</a>
                </div> <!-- /.container -->
            </div> <!-- /.camera_caption -->
        </div>
        <div data-src="users/images/home/slide-2.jpg">
            <div class="camera_caption">
                <div class="container">
                    <p class="wow fadeInUp animated">The government they survive artical of fortune</p>
                    <h1 class="wow fadeInUp animated" data-wow-delay="0.2s">We IMPROVE YOUR <br>SALES EFFICIENCY</h1>
        ...
        <div data-src="users/images/home/slide-3.jpg">
            <div class="camera_caption">
                <div class="container">
                    <p class="wow fadeInUp animated">The government they survive artical of fortune</p>
                    <h1 class="wow fadeInUp animated" data-wow-delay="0.2s">We IMPROVE YOUR <br>SALES EFFICIENCY</h1>
        ...
        <div class="top-features-slide">
            <div class="item">
                <div class="main-content" style="background:#fafafa;">
                    <img src="users/images/icon/1.png" alt="">
            ...
            <div class="item">
                <div class="main-content" style="background:#f6f6f6;">
                    <img src="users/images/icon/2.png" alt="">
            ...
            <div class="item">
                <div class="main-content" style="background:#efefef;">
                    <img src="users/images/icon/3.png" alt="">
            ...
            <div class="item">
                <div class="main-content" style="background:#e9e9e9;">
                    <img src="users/images/icon/4.png" alt="">
    ...
    <div class="about-compnay section-spacing">
        <div class="container">
            <div class="row">
                <div class="col-lg-6 col-12"><img src="users/images/home/1.jpg" alt=""></div>
                <div class="col-lg-6 col-12">
                    <div class="text">
                        <div class="theme-title-one">
                            <h2>About Our Company</h2>
                            <p>A tale of a fateful trip that started from this tropic port aboard this tiny ship today still
                                wanted by the government they survive as soldiers of fortune to a deluxe apartment in the
                                sky moving on up to the east side a family.</p>
                            <p>The government they survive as soldiers of fortune baby if you've ever wondered the east side
                                to a deluxe apartment.</p>
                        </div> <!-- /.theme-title-one -->
                ...
                <div class="row">
                    <div class="col-xl-4 col-md-6 col-12">
                        <div class="single-service">
                            <div class="img-box"><img src="users/images/home/3.jpg" alt=""></div>
                            <div class="text">
                                <h5><a href="service-details.html">Business Services</a></h5>
                                <p>The tiny ship today stiller</p>
                                <a href="service-details.html" class="read-more">READ MORE <i class="fa fa-angle-right"
                    ...
                    <div class="col-xl-4 col-md-6 col-12">
                        <div class="single-service">
                            <div class="img-box"><img src="users/images/home/4.jpg" alt=""></div>
                            <div class="text">
                    ...
                    <div class="col-xl-4 col-md-6 col-12">
                        <div class="single-service">
                            <div class="img-box"><img src="users/images/home/5.jpg" alt=""></div>
                            <div class="text">
                    ...
                    <div class="col-xl-4 col-md-6 col-12">
                        <div class="single-service">
                            <div class="img-box"><img src="users/images/home/6.jpg" alt=""></div>
                            <div class="text">
                    ...
                    <div class="col-xl-4 col-md-6 col-12">
                        <div class="single-service">
                            <div class="img-box"><img src="users/images/home/7.jpg" alt=""></div>
                            <div class="text">
                    ...
                    <div class="col-xl-4 col-md-6 col-12">
                        <div class="single-service">
                            <div class="img-box"><img src="users/images/home/8.jpg" alt=""></div>
                            <div class="text">
                ...
                <div class="wrapper">
                    <div class="bg">
                        <div class="testimonial-slider">
                            <div class="item">
                                <p>“ A tale of a fateful trip that started from this tropic port aboard this tiny ship today
                                    still wanted by the government they survive as soldiers of fortune to a deluxe apartment
                                    in the sky moving on up to the east side a family. ”</p>
                                <div class="name">
                                    <h6>Shawn Michael</h6>
                ...
                <div class="row">
                    <div class="col-lg-3 col-sm-6 col-12">
                        <div class="team-member">
                            <div class="image-box">
                                <img src="users/images/team/1.jpg" alt="">
                                <div class="overlay">
                    ...
                    <div class="col-lg-3 col-sm-6 col-12">
                        <div class="team-member">
                            <div class="image-box">
                                <img src="users/images/team/2.jpg" alt="">
                                <div class="overlay">
                                    <div class="hover-content">
                                        <ul>
                                            <li><a href="#"><i class="fa fa-facebook" aria-hidden="true"></i></a>
                    ...
                    <div class="col-lg-3 col-sm-6 col-12">
                        <div class="team-member">
                            <div class="image-box">
                                <img src="users/images/team/3.jpg" alt="">
                                <div class="overlay">
                                    <div class="hover-content">
                                        <ul>
                                            <li><a href="#"><i class="fa fa-facebook" aria-hidden="true"></i></a>
                    ...
                    <div class="col-lg-3 col-sm-6 col-12">
                        <div class="team-member">
                            <div class="image-box">
                                <img src="users/images/team/4.jpg" alt="">
                                <div class="overlay">
                                    <div class="hover-content">
                                        <ul>
                                            <li><a href="#"><i class="fa fa-facebook" aria-hidden="true"></i></a>
            ...
            <div class="row">
                ...
                <div class="col-md-9 col-sm-8 col-12">
                    <div class="partner-slider">
                        <div class="item"><img src="users/images/logo/p-1.png" alt=""></div>
                        <div class="item"><img src="users/images/logo/p-2.png" alt=""></div>
                        <div class="item"><img src="users/images/logo/p-3.png" alt=""></div>
                        <div class="item"><img src="users/images/logo/p-4.png" alt=""></div>
                        <div class="item"><img src="users/images/logo/p-5.png" alt=""></div>
                    </div>
                </div>
            </div>
        </div>
